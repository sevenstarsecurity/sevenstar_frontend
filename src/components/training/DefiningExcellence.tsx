    ...
    <section className="py-20 md:py-24 bg-[#f7faf3]" ref={ref}>
      <div className="max-w-[1600px] mx-auto px-4 md:px-10 lg:px-12 text-center">
        ...
        <div className="mb-14 max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-wider text-[#0b4226] uppercase mb-3">
            DEFINING EXCELLENCE
          </h2>
          <p className="text-gray-600 text-xs md:text-sm leading-relaxed">
            Our training program isn't just about physical preparedness; it's about building an elite<br></br> mindset for modern security challenges.
          </p>
        </div>
